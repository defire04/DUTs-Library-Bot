...
Виберіть спосіб пошуку книг🔍
    ...
    help_info_message = MessageCreator(
        """
Інструкція з роботи з роботом.
Щоб розпочати роботу з ботом, потрібно натиснути кнопку "Почати!"
...
·Якщо Ви оберете кнопку "Назва книги", вам буде надіслано повідомлення, на яке ви можете надіслати назву бажаної книги. Якщо не знаєте точну назву не біда, можна написати зразкову назву і бот все знайде. Наприклад С#.
...
Кнопка сортування має вибір сортування "↕". Натиснувши кнопку, ви можете вибрати, як Ви хочете сортувати книги.
